...
class Major_Store extends StatefulWidget {
  const Major_Store({Key? key}) : super(key: key);

  @override
  State<Major_Store> createState() => _Major_StoreState();
}

int count_Click = 0;
MyMajorModel? majorModel;

class _Major_StoreState extends State<Major_Store> {
