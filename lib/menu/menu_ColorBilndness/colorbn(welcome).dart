...
//####################    Start Method    ##############//
  ...
  Future<Null> prefer_colorblindness() async {
    ...
    String? std_idcard = preferences.getString('std_idcard');
    String? std_colorbn = preferences.getString('std_colorbn');
    String apiprofile =
        '${MyConstant.domain}/project/get_color.php?isConnect=true&std_id=$std_id&std_idcard=$std_idcard&std_colorbn=$std_colorbn';
